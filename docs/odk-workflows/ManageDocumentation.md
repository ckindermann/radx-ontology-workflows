...
The documentation for RXOW is managed in two places (relative to the repository root):
...
2. Now you are ready to build the docs as follows:
   ...
   ```
   INFO    -  Your documentation should shortly be available at: https://ckindermann.github.io/radx-ontology-workflows/ 
   ```
3. Just to double check, you can now navigate to your documentation pages (usually https://ckindermann.github.io/radx-ontology-workflows/). 
