 ...
 * [rxow.yml](rxow.yml)
     * Determines how your purl.obolibrary.org/obo/rxow/ redirects will be handled
     ...
     * Paste in the contents of [rxow.yml](rxow.yml)
 ...
 * [rxow.md](rxow.md)
     ...
     * Paste in the contents of [rxow.md](rxow.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
